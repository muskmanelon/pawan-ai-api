...
app.get('/:sentence', (req, res) => {
  ...
  const options = {
    ...
    body: JSON.stringify({
      ...
      "max_tokens": 100,
      "temperature": 0.7,
      "prompt": "Generate the exact opposite of the following sentence as your answer. Set the Sentence between two '~'. Also don't answer anything else but the exact opposite: '" + sentence + "'."
    })
  };
